...
\begin{enumerate}
  ...
  \item \textbf{Estimate 2} performs the annular $r$--$z$ diffusion study used
...
\begin{center}
\begin{tabular}{p{2.7cm}p{4.0cm}p{6.0cm}}
\toprule
Layer & Model & Purpose \\
\midrule
Notebook estimate 1 & Homogeneous buckling & First-pass analytical check of size and leakage trends \\
Notebook estimate 2 / Core page & Steady 2D one-group diffusion & Compute $k_{\mathrm{eff}}$, flux maps, and rod-worth calibration \\
Overview page & 0D six-group point kinetics & Fast transient driven by the notebook-derived reactivity curve \\
