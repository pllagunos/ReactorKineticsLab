...
The notebook is an important \textbf{calibration and derivation workspace}, while
...
The repository currently implements a hierarchy of reduced reactor models with
increasing spatial fidelity.  The notebook remains the physics workbench that
derives the one-group annular-core picture, performs the 2D criticality and
rod-worth studies, and helps justify the frozen constants used by the backend.
